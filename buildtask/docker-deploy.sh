...
ENV_VARS="[\"ES_ENV=prod\",\"ES_AUTHENTICATION_SERVER=${PROD_AUTH_SERVER}\",\"ES_AUTHENTICATION_PORT=1337\",\"ES_SESSION_SERVER=${PROD_SESSION_SERVER}\",\"ES_SESSION_PORT=6379\",\"ES_DB_SERVER=${PROD_DB_SERVER}\",\"ES_DB_USER=${PROD_DB_USER}\",\"ES_DB_PASSWORD=${PROD_DB_PASSWORD}\",\"ES_API_KEY_ID=${PROD_API_KEY_ID}\", \"ES_API_KEY_SECRET=${PROD_API_KEY_SECRET}\"]"
